          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="space-y-6 text-lg text-slate-300 leading-relaxed">
                <p>
                  I'm a Senior ML Engineer with a passion for making machines smarter and more efficient. My journey, which includes dual Ph.D. degrees in Data Science and Engineering, has given me a deep foundation in Computer Vision, Generative AI, optimization theory, and signal processing.
                </p>
                
                <p>
                  My work has centered on a core challenge: how can we drastically compress data without losing what makes it meaningful? To solve this, I specialize in using Machine Learning to achieve extreme compression for images, video, and other media. I develop intelligent systems that preserve the essential information within the data, all while being optimized to run smoothly on edge devices with limited power.
                </p>
                
                <p>
                  I have collaborated with leading academic institutions, including Sapienza University of Rome, TU Berlin, and the National Inter-University Consortium for Telecommunications (CNIT), as well as various industry partners specialized in satellite technology. My research papers have been published in top-tier conferences and journals, pushing the boundaries of semantic communications and generative AI applications.
                </p>
                
                <p>
                  From drones to sattelites, going throught any kind of edge devices...if it can run some kind of ML model, I want to make it smarter and more efficient. 
                </p>
              </div>
            </div>
