...
![correlation](/images/projects/pm10/correlation.webp "md:w-1/3 lg:w-1/3 mx-auto | Upper triangle of the correlation Matrix for PM10 between Modena, Bologna and Parma.")
...
![Scatter plot](/images/projects/pm10/scatter_plot_city.webp "md:w-2/3 lg:w-2/3 mx-auto | Scatter plot between predicted and true values of PM10 in Modena.")
---
...
![Modena's correlation](/images/projects/pm10/modena_correlation.webp "md:w-2/3 lg:w-2/3 mx-auto | Upper triangle of the correlation Matrix of Modena's Local Pollutants (After Imputation).")
...
![Scatter plot](/images/projects/pm10/scatter_plot_modena.webp "md:w-2/3 lg:w-2/3 mx-auto | Predicted vs. Actual PM10 for Modena (Local Factors Model).")
