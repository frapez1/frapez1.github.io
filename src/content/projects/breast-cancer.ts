...
![Breast Cancer types](/src/assets/projects/breast-cancer/breat_cancer_types.png "md:w-2/3 lg:w-2/3 mx-auto | Example of DBT for a Malignant, a Benign and a Normal case")
...
![Cleaned DBT](/src/assets/projects/breast-cancer/breast_cancer_denoised.png "md:w-2/3 lg:w-2/3 mx-auto | The use of a two-pass binary connected-component labeling algorithm, which identifies all distinct connected component, allowed to detect and remove the text and produce the clean image on the RIGHT.")
