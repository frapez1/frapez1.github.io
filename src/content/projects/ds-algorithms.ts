...
![Sorting speed](/images/projects/ds_algorithms/sorting.webp "md:w-2/3 lg:w-2/3 mx-auto | Empirical running time of the counting sort algorithm")
-----
...
![Clustering](/images/projects/ds_algorithms/clustering.webp "md:w-2/3 lg:w-2/3 mx-auto | Intermediate frame of the animation with cluster and associated SSD.")
...
![Clustering](/images/projects/ds_algorithms/k_mean.webp "md:w-2/3 lg:w-2/3 mx-auto | Visual example of the difference in performances between k-mena and k-median.")
  `
